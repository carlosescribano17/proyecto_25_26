 ...
 * @author DAM2Alu7
 */
public class JFrameFlatLafSetUp extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(JFrameFlatLafSetUp.class.getName());

    /**
     * Creates new form JFrameFlatLaf
     */
    public JFrameFlatLafSetUp() {
        initComponents();
...
//        jComboBoxLookandFeel.getSelectedIndex()];
        ...
        try {
            ...
            System.getLogger(JFrameFlatLafSetUp.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
        }
        SwingUtilities.updateComponentTreeUI(this);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new JFrameFlatLafSetUp().setVisible(true));
    }
