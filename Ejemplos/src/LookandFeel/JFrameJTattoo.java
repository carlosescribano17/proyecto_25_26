 ...
 * @author DAM2Alu7
 */
public class JFrameJTattoo extends javax.swing.JFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(JFrameJTattoo.class.getName());

    /**
     * Creates new form JFrameJTattoo
     */
    public JFrameJTattoo() {
        initComponents();
        try {
            UIManager.setLookAndFeel("com.jtattoo.plaf.hifi.HiFiLookAndFeel");
        } catch (ClassNotFoundException ex) {
            System.getLogger(JFrameJTattoo.class.getName()).log(System.Logger.Level.ERROR, (String) null, ex);
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING)
                    .addComponent(jComboBoxLookandFeel, javax.swing.GroupLayout.PREFERRED_SIZE, 103, javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new JFrameJTattoo().setVisible(true));
    }
