...
CREATE TABLE empleados (
    ...
    contrasena VARCHAR(255) NOT NULL, -- Almacenar hasheada con BCrypt
...
-- ================================================
-- TABLA: Lineas_Venta (Detalle de productos vendidos)
-- ================================================
...
-- ================================================
-- Contraseña: "admin123" y "vendedor123" (en producción usar BCrypt)
...
-- ================================================
-- DATOS DE EJEMPLO - Productos: GUITARRAS
-- ================================================
...
-- ================================================
-- DATOS DE EJEMPLO - Productos: AMPLIFICADORES
-- ================================================
INSERT INTO productos (nombre, marca, precio, stock, tipo_producto, descripcion, imagen_url) VALUES
...
-- ================================================
-- DATOS DE EJEMPLO - Productos: ACCESORIOS
-- ================================================
INSERT INTO productos (nombre, marca, precio, stock, tipo_producto, descripcion, imagen_url) VALUES
