...
; Si quieres incluir un runtime de Java dentro del instalador,
; genera antes una carpeta "runtime" y descomenta la siguiente linea:
...
begin
  ...
  LauncherContent :=
    ...
    'if exist "%APP_HOME%runtime\bin\javaw.exe" (' + #13#10 +
    '  start "" "%APP_HOME%runtime\bin\javaw.exe" -jar "%APP_HOME%TPVNoteERP.jar"' + #13#10 +
    ') else (' + #13#10 +
